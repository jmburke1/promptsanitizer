...
```bash
curl -fsSL https://raw.githubusercontent.com/jmburke1/promptsanitizer/v1.2.0.1-tui/install.sh | bash
```

This downloads the source, compiles it with Java 21+, and installs a `promptsanitizer` command to `/usr/local/bin`.

```bash
curl -fsSL https://raw.githubusercontent.com/jmburke1/promptsanitizer/v1.2.0.1-tui/localinstall.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/jmburke1/promptsanitizer/v1.2.0.1-tui/uninstall.sh | bash
```

and

```bash
curl -fsSL https://raw.githubusercontent.com/jmburke1/promptsanitizer/v1.2.0.1-tui/localuninstall.sh | bash
```
