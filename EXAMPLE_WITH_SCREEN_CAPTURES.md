...
![An Example Unsanitized Prompt](docs/before_sanitizing.png)
...
![Clicking Tilde And Bringing Up The Dictionary Editor](docs/clicking_tilde.png)
...
![Sanitized And Ready To Go Out](docs/sanitized_prompt_ready_to_go_out.png)
...
![Actual Contents of Dictionary on My Computer](docs/actual_personal_dictionary_json_file.png)

Now, back to the main flow of ideas, here is the answer I got back from the LLM:

![Contains Unicorn not Chimera](docs/answer_from_llm.png)
...
![Performed String Substitutions in Reverse](docs/after_substituting_in_reverse.png)
