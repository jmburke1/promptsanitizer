...
REPO_URL="https://github.com/jmburke1/promptsanitizer/archive/refs/tags/v1.0.1.zip"
#Changed this back to REPO_URL="https://github.com/jmburke1/promptsanitizer/archive/refs/heads/main.zip" when done cutting release tag
...
pushd promptsanitizer-1.0.1
#Change this back to pushd promptsanitizer-main when done cutting the release tag
sudo mv * ../
sudo mv .gitignore ../
sudo mv .gitattributes ../
popd
sudo rmdir promptsanitizer-1.0.1
#Change this back to sudo rmdir promptsanitizer-main when cutting the release tag
